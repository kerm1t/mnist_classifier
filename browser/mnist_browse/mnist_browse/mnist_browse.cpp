// mnist_browse.cpp : Defines the entry point for the application.
//
// http://www-cs.ccny.cuny.edu/~wolberg/capstone/learning/DeepLearning_Glassner1.pdf
// get mnist data from here:
// http://yann.lecun.com/exdb/mnist/

#include "stdafx.h"
#include "mnist_browse.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_MNISTBROWSE, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MNISTBROWSE));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MNISTBROWSE));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_MNISTBROWSE);
